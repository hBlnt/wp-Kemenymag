...
<div class="container px-4 px-lg-5">
    <div class="row gx-4 gx-lg-5 align-items-center my-5">
        ...
        <form method="post" action="user_sent_exercise_num.php">

            <label for="number">How many exercises:</label>
            <input type="number" name="number" id="number" required max="22">
