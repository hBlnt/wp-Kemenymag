...
<div class="container px-4 px-lg-5">
    ...
    if (isset($_SESSION['username'])) {
        echo'
    <h1 class="font-weight-light">Welcome '.$_SESSION['firstname'].'!</h1>
    ';
    }
    ?>
    </div>
    ...
    <div class="row gx-4 gx-lg-5 align-items-center my-5">
        ...
        <div class="col-lg-5">
            ...
            <p>We provide platform for trainers and users who want to do sports in a professional and custom way.</p>
            <a class="btn btn-primary" href="aboutus.php">Learn more</a>
        </div>
    </div>

    <h1 class="font-weight-light my-4">If you have any questions or suggestions contact us here:<br>
    personaltrainerhelp2023@gmail.com
    </h1>
